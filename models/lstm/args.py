...
def get_args():
    ...
    parser.add_argument('--lr', type=float, default=0.0005)  # Thesis was 0.00001
    parser.add_argument('--batch-size', type=int, default=16)
    parser.add_argument('--embed-droprate', type=float, default=0.1, help="embedding dropout")  # thesis was 0.1
    parser.add_argument('--wdrop', type=float, default=0.01, help="weight drop")  # thesis was 0.3
